...
if __name__ == '__main__':
    ...
    # parser.add_argument('--file_name', type=str, default='Test', help='Name for saving the file')
    parser.add_argument('--file_name', type=str, default='Test', help='Name for saving the file')
    ...
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'test', 'test_sep'])
